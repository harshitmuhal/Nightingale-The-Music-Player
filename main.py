...
def about_us():
    messagebox.showinfo('Nightingale','Developer - Harshit Muhal')
...
photo=PhotoImage(file='/Users/harshitmuhal/Downloads/button.gif')
playbtn=ttk.Button(buttonframe,image=photo,command=play_btn)
playbtn.grid(row=0,column=0)

#stop button
photo2=PhotoImage(file='/Users/harshitmuhal/Downloads/stop.gif')
stopbtn=ttk.Button(buttonframe,image=photo2,command=stop_btn)
stopbtn.grid(row=0,column=1)

#pause button
photo3=PhotoImage(file='/Users/harshitmuhal/Downloads/pause.gif')
pausebtn=ttk.Button(buttonframe,image=photo3,command=pause_btn)
...
#rewind button
photo4=PhotoImage(file='/Users/harshitmuhal/Downloads/rewind.gif')
rewindbtn=ttk.Button(bottomframe,image=photo4,command=play_btn)
rewindbtn.grid(row=0,column=0)

mutephoto=PhotoImage(file='/Users/harshitmuhal/Downloads/mute.gif')
volphoto=PhotoImage(file='/Users/harshitmuhal/Downloads/vol.gif')
volbtn=ttk.Button(bottomframe,image=volphoto,command=mute_btn)
